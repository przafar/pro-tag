<template>
  <div class="container mx-auto px-2">
    <div class="grid grid-cols-5 gap-4 mt-8">
      ...
      <div class="lg:col-span-3 xl:col-span-3 col-span-3">
        ...
        <div class=" w-full overflow-auto chart">
          <div class="grid grid-cols-5 gap-2 w-full">
              ...
              <div class="col-span-1 text-center text-green-500 font-semibold">
                <p>Active</p>
              </div>
              <div class="col-span-1 text-center">
                <p>Link:</p>
          ...
          <li class="flex my-4" v-for="(u, index) in filteredBlogs" :key="index">
            <div class="grid grid-cols-5 gap-2 w-full">
              ...
              <div class="col-span-1 text-center">
                <h2 v-if="u.profile.name.length > 2" class="text-green-500"><i class="fas fa-check"></i></h2>
                <h2 v-else class="text-red-500"><i class="fas fa-times"></i></h2>
              </div>
              <div class="col-span-1 text-center">
